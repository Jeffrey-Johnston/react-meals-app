...
const getStaticProps = async () => {
  const client = await external_mongodb_["MongoClient"].connect("mongodb+srv://jjohns1822:Lazerus99@cluster0.lysvn.mongodb.net/meetups?retryWrites=true&w=majority");
  const db = client.db();
...
/* harmony default export */ var pages = __webpack_exports__["default"] = (HomePage); // export const getServerSideProps = async (context) => {
